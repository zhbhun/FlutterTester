...
class FlutterPickerExample extends StatefulWidget {
  static final example = ExampleItem(
      title: 'flutter_picker', widget: () => FlutterPickerExample());
  @override
  _FlutterPickerExampleSstate createState() => _FlutterPickerExampleSstate();
}

class _FlutterPickerExampleSstate extends State<FlutterPickerExample> {
  @override
